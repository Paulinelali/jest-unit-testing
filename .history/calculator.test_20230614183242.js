...
describe('Subtract num2 from num1', () => {
    ...
    test('Throw error on negative param1', () => {
        expect( () => {Calculator.subtract(-2, 23)}).toThrow()
    })

    test('Throw error on negative param2', () => {
...
describe('Divide num1 by num2', () => {
    ...
    test('Throw error on negative numerator', () => {
        expect( () => {Calculator.divide(-4, 2)}).toThrow()
    })
    
    test('Throw error on negative denominator', () => {
